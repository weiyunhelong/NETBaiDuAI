    ...
    $.nfinetab = {
        ...
        addTab: function () {
            ...
            if (flag) {
                ...
                var str1 = '<iframe style="padding: 20px 30px; " class="NFine_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="' + height + '" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
