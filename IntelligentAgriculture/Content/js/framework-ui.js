$(function () {
    ...
    //$("[data-toggle='tooltip']").tooltip();    2017-06-20 注释
})
$.reload = function () {
    location.reload();
    return false;
...
$.modalOpen = function (options) {
    var defaults = {
        id: null,
        title: ['系统窗口', "background:#539214;color:#fff;text-align:left;font-size:16px;margin: 0px;padding-left: 10px;"],
        width: "600px",
        height: "550px",
        url: '',
        shade: 0.3,
        btn: ['确 定', '取 消'],
        btnclass: ['btn-pop-ok', 'btn-pop-cancel'],
        callBack: null,
        cancelBack: null
    };
...
$.modalOpenNoTop = function (options) {
    var defaults = {
        id: null,
        title: '系统窗口',
        width: "600px",
...
$.modalConfirm = function (content, callBack1, callBack2) {
...
$.modalConfirmNew = function (content, title, callBack1, callBack2) {
    top.layer.confirm(content, {
        icon: "fa-exclamation-circle",
        title: title,
        btn: ['确 定', '取 消'],
...
$.fn.dataGrid = function (options) {
    ...
    options["onSelectRow"] = function (rowid) {
        ...
        if (length > 0) {
            ...
            $operate.animate({ "left": '-102.1%' }, 200);
        }
